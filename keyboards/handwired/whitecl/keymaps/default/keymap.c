...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+--------|
     KC_LCTL ,KC_LALT ,KC_LGUI ,KC_LGUI ,KC_L1   ,    KC_SPC       ,KC_L2   ,TG(_GM) ,KC_LEFT ,KC_DOWN ,KC_RGHT
  //`--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+--------'
  ),
...
[_RAISE] = LAYOUT(
  ...
  KC_PGDN, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_F12,
  KC_HOME, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  KC_END,  UNDO,    CUT,     COPY,    PASTE,   _______, _______, _______, _______, _______, KC_VOLU, _______,
...
[_ADJUST] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, STANDUP, _______, _______, KC_BRIU, _______,
