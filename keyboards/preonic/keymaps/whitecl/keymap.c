...
[_LOWER] = LAYOUT_preonic_1x2uC(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_PIPE, KC_LCBR, KC_RCBR, KC_DEL,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_QUOT, KC_DQUO,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_QUES, KC_BSLS, KC_BSLS,
...
[_RAISE] = LAYOUT_preonic_1x2uC(
  ...
  KC_END,  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLU, KC_VOLU,
...
[_ADJUST] = LAYOUT_preonic_1x2uC(
  ...
  _______, _______, KC_SLEP, _______, _______, TG(_GM), _______, _______, _______, TG(_LI), _______, _______,
...
/* Linux mode, put LCTRL on one of the GUIs */
[_LI] = LAYOUT_preonic_1x2uC(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
